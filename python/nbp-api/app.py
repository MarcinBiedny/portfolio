...
print(
    "This program allows you to check the average rates of the following currencies: USD, AUD, EUR, CHF, JPN, ZMW (kwacha zambijska), MDL (lej Mołdawii), ARS (peso argentyńskie)."
)
